...
<div class="jumbotron">
  ...
  <ul class="lead">
    <li>
      <i class="fa fa-exclamation-triangle"></i>&nbsp;Angular 2 is still in beta. On top of any normal beta issues, another issue is plain JavaScript documentation and tutorials are extremely limited. A new user of Angular 2 is highly encouraged to go the TypeScript route rather than this project's pure JS route.
    </li>
    <li>
